...
export const VIBEFUL_NODE_TYPES: VibefulNodeType[] = [
  ...
  // ── Analysis ──
  {
    ...
    configSchema: [
      { key: 'phase_memories', label: 'Memories', type: 'boolean', defaultValue: true },
      { key: 'phase_impressions', label: 'Impressions', type: 'boolean', defaultValue: true },
      { key: 'phase_concepts', label: 'Concepts', type: 'boolean', defaultValue: true },
      { key: 'phase_assumptions', label: 'Assumptions', type: 'boolean', defaultValue: true },
      { key: 'phase_intent', label: 'Intent', type: 'boolean', defaultValue: true },
      { key: 'phase_code_detect', label: 'Code Detect', type: 'boolean', defaultValue: true },
      { key: 'phase_search_detect', label: 'Search Detect', type: 'boolean', defaultValue: true },
      { key: 'phase_global_memories', label: 'Global Memories', type: 'boolean', defaultValue: true },
      { key: 'phase_next', label: 'Next Actions', type: 'boolean', defaultValue: true },
      { key: 'phase_search_execute', label: 'Search Execute', type: 'boolean', defaultValue: true },
      { key: 'phase_conductor', label: 'Conductor', type: 'boolean', defaultValue: true },
